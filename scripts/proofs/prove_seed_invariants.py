...
L0_FORBIDDEN_EXTENSION_IMPORT_ROOTS = [
    ROOT / "CODE" / "core_kernel",
    ROOT / "CODE" / "governance",
    ROOT / "CODE" / "tool_gateway" / "seed_tools",
    ROOT / "CODE" / "kernel_composition" / "local_seed_ports",
]
...
def main() -> int:
    manifest = load_yaml(ROOT / "SEED_PACKAGE_MANIFEST.yaml")
    ...
    seed_tools = ROOT / "CODE" / "tool_gateway" / "seed_tools"
