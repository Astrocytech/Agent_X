...
MANDATORY_GATES = {"FRMVP", "AdapterMVP", "Alpha", "Beta", "Governed", "Memory", "GitPromotion", "Final"}
...
def validate() -> list[str]:
    ...
    for row in rows:
        ...
        # Check evidence refs for PASS rows
        if status == "PASS":
        ...
        if required == "true" and status not in ("PASS", "BLOCKED_WITH_REASON"):
