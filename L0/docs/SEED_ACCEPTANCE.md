...
- [ ] Every L0/CODE/ Python file is listed in SEED_PACKAGE_MANIFEST.yaml
...
- [ ] Only emit_answer.py exists in L0/CODE/tool_gateway/seed_tools/
...
- [ ] `L1/docs/INVERSE_SCIENCE.txt`, if present, is advisory documentation only.
- [ ] It is not imported by any `L0/CODE/` runtime module.
