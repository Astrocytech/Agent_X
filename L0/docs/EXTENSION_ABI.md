...
An external agent may use `L1/docs/INVERSE_SCIENCE.txt` to choose better candidate changes, but any actual capability must still attach through the allowed extension points and satisfy this ABI.
...
- add tool implementation files to L0/CODE/tool_gateway/seed_tools/
