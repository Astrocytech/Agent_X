...
_PROTECTED_PATHS: set[str] = {
    ...
    "L0/CODE/core_kernel/contracts",
    "L0/CODE/core_kernel/public",
    "L0/CODE/core_kernel/runtime/seed_runtime.py",
    "L0/CODE/tool_gateway/seed_tool_registry.py",
}
...
def _assess_seed_boundary_impact(target_files: list[str]) -> str:
    for f in target_files:
        ...
        if "SEED_POLICY" in f or "authority" in f.lower():
            return "high"
        if f.startswith("L0/CODE/core_kernel/contracts"):
            return "medium"
    return "low"
