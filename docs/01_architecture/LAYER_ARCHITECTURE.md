...
intended_location: "docs/fic/01_whole_system_pseudocode.md"
authority_level: "whole-system-flow"
last_updated: "2026-05-31"
governed_by:
  - "docs/fic/00_system_goal.md"
requires:
  - "docs/fic/02_shared_types_and_interfaces.md"
  - "docs/fic/03_traceability_matrix.md"
  - "docs/fic/units/*.md"
supersedes:
...
All pseudocode in this document must remain consistent with `docs/fic/00_system_goal.md`.
...
Procedure LoadGoverningContext(classified_request):
  ...
  context.system_goal ← Load("docs/fic/00_system_goal.md")

  context.architecture_contract ← LoadIfExists("docs/fic/architecture_contract.md")

  context.whole_system_pseudocode ← Load("docs/fic/01_whole_system_pseudocode.md")

  context.shared_interfaces ← LoadIfExists("docs/fic/02_shared_types_and_interfaces.md")

  context.traceability_matrix ← LoadIfExists("docs/fic/03_traceability_matrix.md")
...
- it can be used as a source document for `docs/fic/units/*.md`
