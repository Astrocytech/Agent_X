...
intended_location: "docs/fic/02_shared_types_and_interfaces.md"
...
- it provides enough structure for `docs/fic/units/*.md` to reference instead of redefining shared contracts
