...
intended_location: "docs/fic/00_system_goal.md"
authority_level: "root-goal"
last_updated: "2026-05-31"
governs:
  - "docs/fic/01_whole_system_pseudocode.md"
...
1. Place this file at `docs/fic/00_system_goal.md`.
2. Reference it from the FIC or standards README.
3. Create or update `01_whole_system_pseudocode.md` to align with this goal.
4. Create or update `02_shared_types_and_interfaces.md` to define shared terms and contracts.
...
```text
[ ] It is placed at docs/fic/00_system_goal.md.
